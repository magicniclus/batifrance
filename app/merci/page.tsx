...
export default function MerciPage() {
  useEffect(() => {
    // Événement de conversion Google Ads pour "Envoi de formulaire pour leads"
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'conversion', {
        'send_to': 'AW-764459220/BfocInGsAcBJj7tiR',
        'value': 1.0,
        'currency': 'EUR'
      });
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.div
          className="bg-gradient-to-r from-slate-700 to-slate-800 text-white p-8 text-center"
        ...
        >
          ...
          <div className="space-y-6 mb-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Nous étudions votre projet d'électricité, peinture ou plâtrerie et déterminons la meilleure approche pour vos travaux.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Notre équipe vous contacte pour affiner votre projet et planifier l'intervention de nos 3 collaborateurs qualifiés.
                </p>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">06 05 59 88 97</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">exfactor.fr@gmail.com</p>
          ...
          >
            <Link href="/" className="flex-1">
              <Button className="w-full bg-slate-700 hover:bg-slate-800 text-white py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
